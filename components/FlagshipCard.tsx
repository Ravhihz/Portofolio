...
export default function FlagshipCard() {
  return (
    <div
      ...
      className="group cursor-pointer block border border-[var(--accent)] bg-[var(--surface)] rounded-lg p-6 mb-4 shadow-lg shadow-black/25 hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-black/40 transition-all"
    >
